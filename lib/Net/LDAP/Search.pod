...
Retunr an array of L<Net::LDAP::Entry> objects hat were returned from the
server.
...
This call will block, if the list is empty, until ther server returns
another entry.
...
not given then the entries will be sorted by thier DN
